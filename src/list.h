...
{
    assert(_new->prev == (struct list_head *)0xcafecafe);
    assert(_new->next == (struct list_head *)0xbabebabe);
...
list_move (struct list_head *list, struct list_head *head)
{
    ...
    list->next = (struct list_head *)0xbabebabe;
    list->prev = (struct list_head *)0xcafecafe;
    list_add (list, head);
}
